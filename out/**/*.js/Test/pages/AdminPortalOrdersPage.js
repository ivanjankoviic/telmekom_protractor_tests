...
var Orders = /** @class */ (function (_super) {
    ...
    Orders.prototype.getRouteOrders = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.wait(until.presenceOf(this.ElementLocator(exports.locatorsOrders.OrdersTableTitle)), 10000).then(function () {
...
//# sourceMappingURL=AdminPortalOrdersPage.js.map